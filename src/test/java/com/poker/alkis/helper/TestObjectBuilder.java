...
public class TestObjectBuilder {
    ...
    public static List<PokerSession> buildPokerSessions() {
        ...
        PokerSession pokerSessionA = new PokerSession(alkis, LocalDate.now(), "", Season.SEASON_2024);
        ...
        PokerSession pokerSessionB = new PokerSession(alkis, LocalDate.now().minusDays(7), "", Season.SEASON_2024);
